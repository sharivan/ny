...
public class BallSprite extends YahooImage {
	...
	public void fe(float j, float i1, YVector _pcls108, Vel _pcls33) {
		j = (int) j;
		i1 = (int) i1;
		setCenter(j, i1);
		...
		if (_pcls33 != null && _pcls33.getAbsVel() > 0) {
			ee(_pcls33);
			bs_r = true;
		}
	}
	...
	public void Ld(float j, float i1, YVector _pcls108, Vel _pcls33) {
	...
	public void setCenter(float j, float i1) {
		super.setCoords((int) (j - radius), (int) (i1 - radius));
		if (bs_o != null)
			bs_o.setCoords((int) (j - radius), (int) (i1 - radius));
	}
	...
	public void Td(float j, float i1) {
		j = (int) j;
		i1 = (int) i1;
		setCenter(j, i1);
		setActive(false);
	...
	public void Wd() {
		setCenter((int) poolBall.getX(), (int) poolBall.getY());
	}
