...
public interface PoolHandler extends GameHandler {
	...
	public abstract YPoint getCenterPoint();

	public abstract YRectangle getInArea();

	public abstract float getLinearFriction();

	public abstract YRectangle getPlayArea();

	public abstract YRectangle getPocketArea();

	public abstract float getRotationFriction();

	public abstract float getSideRotationFriction();
	...
	public abstract void handleSetPos(int i, int j, float k, float l,
	...
	public abstract void handleWon(YData _pcls111);
