...
public class YahooPoolTable extends YahooTable implements PoolHandler {
	...
	public Pool			pool;
	public YPoint		cueDist;
	public YPoint		englishDist;
	public YPoint		firstColl;
	public int			collBall;
	...
	private void changeBall(YahooConnectionId id, int i0, float i1, float i2) {
		synchronized (id) {
			writeHeader(id);
			id.write('\uFF9A');
			id.writeInt(i0);
	...
	private void doChangeBall(YahooConnectionId id, int i0, float i1, float i2) {
	...
	private void doStrike(YahooConnectionId id, int sitIndex, int index,
			int collBall, YPoint cueDist, YPoint englishDist, YPoint firstColl)
			throws IOException {
	...
	public void handleSetPos(int i, int j, float k, float l, YVector _pcls48,
			Vel _pcls33) {
		// TODO Auto-generated method stub
